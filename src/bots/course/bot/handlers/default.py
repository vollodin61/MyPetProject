...
from src.bots.sarbot.bot.data.bot_cfg import AvailableState as Avs, bot, admins
from src.bots.sarbot.bot.data.texts import Texts as Txt
from bots.db.requests.async_requests_db_postgres import AsyncORM  # Это всё переехало в database
from bots.db.requests.sync_requests_db_postgres import SyncORM  # Это всё переехало в database
from bots.db.data.db_cfg import UserStatus as Us  # Это всё переехало в database
